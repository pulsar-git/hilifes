...
public:
  ...
  virtual int open (void *)
  {
	...
	if (hilife::network_server_simple::g_reactor->register_handler (this,
    ...
    else if (hilife::network_server_simple::g_reactor->schedule_timer (this,
                                        0,
                                        ACE_Time_Value (2),
                                        ACE_Time_Value (3)) == -1)
      ACE_ERROR_RETURN ((LM_ERROR,
  ...
  virtual void destroy (void)
  {
    ...
    hilife::network_server_simple::g_reactor->remove_handler
      (this,
       ACE_Event_Handler::READ_MASK | ACE_Event_Handler::DONT_CALL);

    /* Cancel that timer we scheduled in open() */
    hilife::network_server_simple::g_reactor->cancel_timer (this);
...
protected:
  ...
  virtual int handle_input (ACE_HANDLE)
  {
    ...
    switch (this->peer ().recv (buf,
	  ...
	  hilife::event_manager::instance().push_event(new hilife::event(hilife::event::HL_CREATE));
    return 0;
  }
